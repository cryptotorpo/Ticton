...
function Home() {
    return (
        <div className="flex flex-col w-full h-[470px] justify-center items-center gap-9">
            <span className="baloo-da title py-0 text-center">Tick-Tock and Check the price</span>
            ...
            <div className="baloo flex justify-center items-center px-[85px] gap-[15px]">
